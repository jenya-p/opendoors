                ...
                >
                    <div class="flex grow flex-col gap-4 md:gap-[1.125rem]">
                        <div class="flex flex-col gap-4">
                            ...
                            >
                                Russian Ministry of Education and Science defines vectors
                                of co-operation with relevant Cambodian departments
                            </h2>
                        </div>
                        ...
                        >
                            <p>
                                Staff training in Russian universities, development of
                                academic mobility and expansion of inter-university
                                co-operation were discussed during talks with Mak Ngoi,
                                Director General for Higher Education of the Ministry of
                                Education
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex grow flex-col gap-4 md:gap-[1.125rem]">
                        <div class="flex flex-col gap-4">
                            ...
                            <h2
                                class="text-[1.125rem] font-bold leading-[1.625rem] transition-colors group-hover:text-blue md:text-[1.5rem] md:leading-9"
                            >
                                Russia intensifies co-operation with the International
                        ...
                        >
                            <p>
                                ...
                                co-operation were discussed during talks with Mak Ngoi,
                                Director General for Higher Education of the Ministry of
                                Education Staff training in Russian universities,
                                development of academic mobility and expansion of
                                inter-university co-operation were discussed ...
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex grow flex-col gap-4 md:gap-[1.125rem]">
                        ...
                        >
                            <p>
                                ...
                                Director General for Higher Education of the Ministry of
                                Education Staff training in Russian universities,
                                development of academic mobility and
                            </p>
                        </div>
                    </div>
