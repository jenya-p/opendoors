<div
    class="glide px-0 pb-8 pt-6 sm:px-0 md:py-16"
    data-per-view="3.5"
    data-gap="24"
>
    ...
    >
        <ul class="glide__slides flex md:pl-[calc((100vw_-_81.5rem)_/_2)]">
            ...
            >
                ...
                >
                    ...
                    <div class="grow text-[1rem] font-medium leading-6">
                        Training tasks similar to those, you will face with at the
            ...
            >
                <a
                    href=""
                    title="Download Program of Subject Area"
                    download
                    class="flex h-full flex-col gap-4 rounded-[1rem] bg-white fill-gray-light p-6 transition-colors md:hover:fill-pink md:hover:text-pink"
                >
                    <div class="text-[1.5rem] font-bold leading-9">
                        Program of Subject Area
                    </div>
            ...
            >
                <a
                    href=""
                    title="Download Interview outline"
                    download
                    class="flex h-full flex-col gap-4 rounded-[1rem] bg-white fill-gray-light p-6 transition-colors md:hover:fill-pink md:hover:text-pink"
                >
                    <div class="text-[1.5rem] font-bold leading-9">
                    ...
                    <div class="grow text-[1rem] font-medium leading-6">
                        For doctoral track’s participants only
                    </div>
            ...
            >
                <a
                    href=""
                    title="Download List of potential scientific supervisors"
                    download
                    class="flex h-full flex-col gap-4 rounded-[1rem] bg-white fill-gray-light p-6 transition-colors md:hover:fill-pink md:hover:text-pink"
                >
                    <div class="text-[1.5rem] font-bold leading-9">
